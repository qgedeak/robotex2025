...
- A minden 10. ciklusban egy plusz msec wárakozás. Így is túlterhelt a proceszor. Fagyás, szenzorfrissítési problémák lehetnek, ezt próbálja kezelni.
```c
// A főciklus 14 másodpercig fut (15000 ms)
...
## 7️⃣ Sebességbecslés és adaptív PID (végül nem használtuk)
