...
| Magyarázat | Diagram |
|----------|-----------|
|A három szenzor esetén, sok a vonal környezetében az informásió, pontos az error meghatározása! Az error jelenti azt a távolságot mely a vonal középvonalától a szenzorcsoport közepének tart! | 4 Szenzor esetén a képen látható elhelyezésben, nagy tterületről jön információ, viszont nem olyan precíz az error mint 3 szenor esetén! ![3_4szenzor diagram](img/3_4sensor.jpg)|
